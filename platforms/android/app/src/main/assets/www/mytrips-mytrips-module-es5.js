...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["mytrips-mytrips-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppMytripsMytripsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMytripsMytripsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MytripsPageRoutingModule", function () {
      return MytripsPageRoutingModule;
    });
    /* harmony import */
    ...
    var _mytrips_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./mytrips.page */
    ...
    var MytripsPageRoutingModule = function MytripsPageRoutingModule() {
      _classCallCheck(this, MytripsPageRoutingModule);
    };

    MytripsPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppMytripsMytripsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MytripsPageModule", function () {
    ...
    var _mytrips_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./mytrips-routing.module */
    "./src/app/mytrips/mytrips-routing.module.ts");
    /* harmony import */


    var _mytrips_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./mytrips.page */
    "./src/app/mytrips/mytrips.page.ts");
    /* harmony import */
    ...
    var MytripsPageModule = function MytripsPageModule() {
      _classCallCheck(this, MytripsPageModule);
    };

    MytripsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _mytrips_routing_module__WEBPACK_IMPORTED_MODULE_5__["MytripsPageRoutingModule"]],
  ...
  /***/
  function srcAppMytripsMytripsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMytripsMytripsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MytripsPage", function () {
      return MytripsPage;
    });
    /* harmony import */
    ...
    var MytripsPage = /*#__PURE__*/function () {
      function MytripsPage(activatRoute, stngs, router, alertSrv, dataSrv) {
        var _this = this;

        _classCallCheck(this, MytripsPage);
      ...
      _createClass(MytripsPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "GetMyTrips",
        value: function GetMyTrips() {
          var _this2 = this;

          this.alertSrv.show();
          var api = "api/list_student_trip";
          var body = {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 8:
                    location = this.dataSrv.getLocationDetails(parseInt(this.Data[i]["destanation"]));
                  ...
                  case 14:
                    this.myTrips = this.Data.filter(function (item) {
        ...
        value: function segmentChanged(evt) {
          ...
          this.myTrips = this.Data.filter(function (item) {
            return item.status == parseInt(evt.detail.value);
          });
        }
      }, {
        key: "Go",
    ...
    MytripsPage.ctorParameters = function () {
      return [{
