...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["notification-notification-module"], {
  ...
  function srcAppNotificationNotificationPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationPage = /*#__PURE__*/function () {
      function NotificationPage(activatRoute, stngs, router, alertSrv, dataSrv) {
        var _this = this;
        ...
        this.activatRoute.queryParams.subscribe(function (res) {
          _this.id = localStorage.getItem("driver_id");
      ...
      _createClass(NotificationPage, [{
        ...
        value: function GetMyNotifications() {
          ...
          this.alertSrv.show();
          var api = "api/student_notification";
          var body = {
          ...
          this.dataSrv.httpPostMethod(api, body).then(function (res) {
            ...
            _this2.Notifications = temp["data"];
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _service__WEBPACK_IMPORTED_MODULE_3__["SettingsService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _service__WEBPACK_IMPORTED_MODULE_3__["AlertService"], _service__WEBPACK_IMPORTED_MODULE_3__["DataService"]])], NotificationPage);
    /***/
  }
}]);
