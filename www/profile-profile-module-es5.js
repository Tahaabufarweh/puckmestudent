...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(location, formBuilder, dataSrv, alertSrv, stngs, modal, plt, menu, router) {
        ...
        menu.enable(true); // this.GetDriverData();
      }
      ...
      _createClass(ProfilePage, [{
        ...
        key: "buildDriverForm",
        value: function buildDriverForm(user) {
          console.log(user);
          ...
          var user_old = JSON.parse(localStorage.getItem("User_Old"));
        ...
        value: function GetDriverData() {
          ...
          this.dataSrv.httpPostMethod(api, body).then(function (res) {
            console.log(res);
            _this.DriverData = JSON.parse(res["data"]);
            console.log(_this.DriverData);
        ...
        value: function Update() {
          ...
          DriverData["active_non"] = 0; //http://pickmeupjo.com/pickmeup/uploads/
          ...
          this.dataSrv.httpPostMethod(api, DriverData).then(function (res) {
            ...
            if (temp["data"] && temp["data"] != {} && temp["data"].length > 0) {
              ...
              temp["data"][0].photo = temp["data"][0].photo ? _this2.stngs.getSetting("baseURL") + temp["data"][0].photo : null;
              temp["data"][0].card_id = temp["data"][0].card_id ? _this2.stngs.getSetting("baseURL") + temp["data"][0].card_id : null;
              temp["data"][0].student_id = temp["data"][0].student_id ? _this2.stngs.getSetting("baseURL") + temp["data"][0].student_id : null;
              localStorage.setItem("User", JSON.stringify(temp["data"][0]));
              _this2.dataSrv.photo = temp["data"][0].photo;
              _this2.dataSrv.User_Name = temp["data"][0].user_name;
              _this2.dataSrv.Phone = temp["data"][0].phone;
              _this2.dataSrv.gender = temp["data"][0].gender;
            ...
            _this2.alertSrv.presentToast("Updated successfully ", "success");

            if (_this2.DriverForm.get("name").value != '' && _this2.DriverForm.get("user_name").value != '' && _this2.DriverForm.get("password").value != '' && _this2.dataSrv.lat != '' && _this2.dataSrv.long != '' && _this2.DriverForm.get("email").value != '' && _this2.DriverForm.get("phone").value != '' && _this2.dataSrv.card_id_name != null && _this2.dataSrv.photo_name != null && _this2.dataSrv.student_id_name != null) {
              _this2.dataSrv.waiting = 0;

              _this2.router.navigate(["../home"], {
                replaceUrl: true
              });
            } else {
              _this2.dataSrv.waiting = 1;

              _this2.router.navigate(["../wait"], {
                replaceUrl: true
              });
        ...
        key: "compareImages",
        value: function compareImages(old_image, upload) {
          if (old_image == null) {
            return old_image;
          } else {
