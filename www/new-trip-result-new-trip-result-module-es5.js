...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["new-trip-result-new-trip-result-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppNewTripResultNewTripResultPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppNewTripResultNewTripResultRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewTripResultPageRoutingModule", function () {
      return NewTripResultPageRoutingModule;
    });
    /* harmony import */
    ...
    var _new_trip_result_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./new-trip-result.page */
    ...
    var NewTripResultPageRoutingModule = function NewTripResultPageRoutingModule() {
      _classCallCheck(this, NewTripResultPageRoutingModule);
    };

    NewTripResultPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppNewTripResultNewTripResultModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewTripResultPageModule", function () {
      return NewTripResultPageModule;
    });
    /* harmony import */
    ...
    var _new_trip_result_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./new-trip-result-routing.module */
    "./src/app/new-trip-result/new-trip-result-routing.module.ts");
    /* harmony import */


    var _new_trip_result_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./new-trip-result.page */
    "./src/app/new-trip-result/new-trip-result.page.ts");
    /* harmony import */
    ...
    var NewTripResultPageModule = function NewTripResultPageModule() {
      _classCallCheck(this, NewTripResultPageModule);
    };

    NewTripResultPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _new_trip_result_routing_module__WEBPACK_IMPORTED_MODULE_5__["NewTripResultPageRoutingModule"]],
  ...
  /***/
  function srcAppNewTripResultNewTripResultPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppNewTripResultNewTripResultPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewTripResultPage", function () {
      return NewTripResultPage;
    });
    /* harmony import */
    ...
    var NewTripResultPage = /*#__PURE__*/function () {
      function NewTripResultPage(dataSrv, router, stngs) {
        _classCallCheck(this, NewTripResultPage);
      ...
      _createClass(NewTripResultPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.user = JSON.parse(localStorage.getItem("User"));
          this.gender = this.user.gender;
          this.Trips = this.dataSrv.FilteredTrips.filter(function (item) {
        ...
        value: function segmentChanged(evt) {
          ...
          if (parseInt(evt.detail.value) != 3 && parseInt(evt.detail.value) == this.gender) this.Trips = this.dataSrv.FilteredTrips.filter(function (item) {
            return item.gender == parseInt(evt.detail.value) || item.gender == 3;
          });else this.Trips = this.dataSrv.FilteredTrips.filter(function (item) {
    ...
    NewTripResultPage.ctorParameters = function () {
      return [{
    ...
    NewTripResultPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-new-trip-result',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-trip-result.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/new-trip-result/new-trip-result.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./new-trip-result.page.scss */
      "./src/app/new-trip-result/new-trip-result.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _service__WEBPACK_IMPORTED_MODULE_2__["SettingsService"]])], NewTripResultPage);
    /***/
  }
}]);
//# sourceMappingURL=new-trip-result-new-trip-result-module-es5.js.map